...
[[nodiscard]] bool checkMeshEqual(const std::vector<scene::Vertex3D> &vertices, const std::vector<u16> &indices, const std::vector<Triangle> &expected);
...
[[nodiscard]] bool checkMeshEqual(const std::vector<scene::Vertex3D> &vertices, const std::vector<u16> &indices, const std::vector<Quad> &expected);
