...
struct TileAnimationParams
{
    ...
    void determineParams(v2u texture_size, int *frame_count, int *frame_length_ms,
            v2u *frame_size) const;
    void getTextureModifer(std::ostream &os, v2u texture_size, int frame) const;
    v2f getTextureCoords(v2u texture_size, int frame) const;
};
