...
void ShadowUniformSetter::onSetUniforms(video::IMaterialRenderer *renderer)
{
	...
	m_shadow_view_proj.set(shadowViewProj.pointer(), renderer);
...
void ShadowDepthShaderCB::OnSetConstants(
		video::IMaterialRenderer *renderer, s32 userData)
{
