...
//! constructor
CGUITabControl::CGUITabControl(IGUIEnvironment *environment, IGUIElement *parent,
		...
		UpButton(0), DownButton(0), TabMaxWidth(0), CurrentScrollTabIndex(0), TabExtraWidth(20)
{
	...
	UpButton = GUIButton::addButton(Environment, core::rect<s32>(0, 0, 10, 10), tsrc,
			this, -1, L"");
	...
	DownButton = GUIButton::addButton(Environment, core::rect<s32>(0, 0, 10, 10), tsrc,
			this, -1, L"");
