 ...
 */
video::GLTexture *guiScalingResizeCached(video::VideoDriver *driver, video::GLTexture *src,
 ...
 */
video::GLTexture *guiScalingImageButton(video::VideoDriver *driver, video::GLTexture *src,
