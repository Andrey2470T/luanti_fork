...
public:
	//! constructor
	IGUIStaticText(IGUIEnvironment *environment, IGUIElement *parent, s32 id, recti rectangle) :
	...
	\param vertical: (u8)GUIAlignment::UpperLeft to align with top edge (default),
