...
void MeshCollector::append(const TileSpec &tile, const scene::Vertex3D *vertices,
...
void MeshCollector::append(const TileLayer &layer, const scene::Vertex3D *vertices,
