...
public:
	...
	{
		MeshMakeData data{getBlockLightPropagator(), ndef(), 1, MeshGrid{1}};
...
const Quad zp{{{{{-h, -h, h}, {0, 0, 1}, 0, {1, 1}}, HW}, {{{h, -h, h}, {0, 0, 1}, 0, {0, 1}}, HW}, {{{h, h, h}, {0, 0, 1}, 0, {0, 0}}, HW}, {{{-h, h, h}, {0, 0, 1}, 0, {1, 0}}, HW}}};
	const Quad yp{{{{{-h, h, -h}, {0, 1, 0}, 0, {0, 1}}, HW}, {{{-h, h, h}, {0, 1, 0}, 0, {0, 0}}, HW}, {{{h, h, h}, {0, 1, 0}, 0, {1, 0}}, HW}, {{{h, h, -h}, {0, 1, 0}, 0, {1, 1}}, HW}}};
	const Quad xp{{{{{h, -h, -h}, {1, 0, 0}, 0, {0, 1}}, HW}, {{{h, h, -h}, {1, 0, 0}, 0, {0, 0}}, HW}, {{{h, h, h}, {1, 0, 0}, 0, {1, 0}}, HW}, {{{h, -h, h}, {1, 0, 0}, 0, {1, 1}}, HW}}};
	const Quad zn{{{{{-h, -h, -h}, {0, 0, -1}, 0, {0, 1}}, HW}, {{{-h, h, -h}, {0, 0, -1}, 0, {0, 0}}, HW}, {{{h, h, -h}, {0, 0, -1}, 0, {1, 0}}, HW}, {{{h, -h, -h}, {0, 0, -1}, 0, {1, 1}}, HW}}};
	const Quad yn{{{{{-h, -h, -h}, {0, -1, 0}, 0, {0, 0}}, HW}, {{{h, -h, -h}, {0, -1, 0}, 0, {1, 0}}, HW}, {{{h, -h, h}, {0, -1, 0}, 0, {1, 1}}, HW}, {{{-h, -h, h}, {0, -1, 0}, 0, {0, 1}}, HW}}};
	const Quad xn{{{{{-h, -h, -h}, {-1, 0, 0}, 0, {1, 1}}, HW}, {{{-h, -h, h}, {-1, 0, 0}, 0, {0, 1}}, HW}, {{{-h, h, h}, {-1, 0, 0}, 0, {0, 0}}, HW}, {{{-h, h, -h}, {-1, 0, 0}, 0, {1, 0}}, HW}}};
}
