...
if [ "$USE_XCODE" == "yes" ]; then
	xcodebuild -project luanti_fork.xcodeproj -scheme luanti_fork.xcodeproj -configuration Release build
	xcodebuild -project luanti_fork.xcodeproj -scheme luanti_fork.xcodeproj -archivePath luanti_fork.xcodeproj archive
else
